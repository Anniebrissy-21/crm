...
def sign_required(fn):
    def wrapper(request,*args,**kwargs):
        if not request.user.is_authenticated:
            messages.error(request,"Invalid Sessions")
...
class EmployeeListView(View):
    def get(self,request,*args,**kwargs):
        ...
        #all depts filter(hr,qa,manager)
...
class EmployeeUpdateView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            form.save()
            messages.success(request,"Employee changed successfully")
...
class SignUpView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if form.is_valid():
            User.objects.create_user(**form.cleaned_data)   #to encryopt password user
